			...
			InitContainers: []v1.Container{
				{
					...
					Args:            append(podInitCloneArgs, "http://github.com/iver-wharf/wharf-cmd", repoVolumeMountPath, "&&", "cd", repoVolumeMountPath, "&&", "git checkout", "feature/aggregator-issue-15", "&&", "cd ../../"),
